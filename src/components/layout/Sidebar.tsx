...
import { Milk, Sprout, Scale, Settings } from 'lucide-react'
...
const navModules: NavModule[] = [
  {
    ...
    icon: <Milk size={18} />,
    base: '/leche',
    dashboardTo: '/leche/dashboard',
    registrosTo: '/leche/registros',
    mapaTo: '/leche/mapa',
  },
  {
    ...
    icon: <Sprout size={18} />,
    base: '/agricola',
    dashboardTo: '/agricola/dashboard',
    registrosTo: '/agricola/registros',
    mapaTo: '/agricola/mapa',
  },
  {
    label: 'Pesaje',
    icon: <Scale size={18} />,
    base: '/pesaje',
    dashboardTo: '/pesaje/dashboard',
    registrosTo: '/pesaje/registros',
    mapaTo: '/pesaje/mapa',
  },
]
          ...
          return (
            <div key={mod.base}>
              <NavLink
                to={mod.dashboardTo}
                className={() =>
                  `${styles.navItem} ${isModuleActive ? styles.groupActive : ''}`
                }
              >
